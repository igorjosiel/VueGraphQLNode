    ...
    <div id="main">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md">
            <h5>
              Sufixos <span class="badge bg-info">{{ prefixes?.length }}</span>
            </h5>
            <div class="card">
              <div class="card-body">
                <ul class="list-group">
                ...
                <br />
                <div class="input-group">
                  <input class="form-control" v-model="sufix" v-on:keyup.enter="addSufix(sufix)" type="text" placeholder="Digite o sufixo" />
                  <div class="input-group-append">
            ...
            <ul class="list-group">
              <li class="list-group-item" v-for="domain in domains" v-bind:key="domain.name">
                <div class="row">
                  ...
                  <div class="col-md text-end">
                    <a class="btn bg-info" v-bind:href="domain.checkout" target="_blank">
